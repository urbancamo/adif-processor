...
import uk.m0nom.adif3.transform.CallsignUtils;
...
import static uk.m0nom.adif3.transform.comment.parsers.FieldParseUtils.parsePwr;
...
public class ClassicCommentTransformer implements CommentTransformer {
    ...
    public ClassicCommentTransformer(YamlMapping config,
        ...
        this.fieldMap = config.asMapping();
